...
<!-- CSS Files -->
<link
	href="<%=request.getContextPath()%>/resources/adminAssets/css/bootstrap.min.css"
	rel="stylesheet" />
<link
	href="<%=request.getContextPath()%>/resources/adminAssets/css/paper-dashboard.css?v=2.0.1"
	rel="stylesheet" />
<!-- CSS Just for demo purpose, don't include it in your project -->
<link
	href="<%=request.getContextPath()%>/resources/adminAssets/demo/demo.css"
	rel="stylesheet" />
</head>
...
<body class="">
		...
		<div class="sidebar" data-color="white" data-active-color="danger">
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li><a href="<spring:url value="/adminView/admin/productInventory" />"> <i class="nc-icon nc-tile-56"></i>
							<p>Table List</p>
					</a></li>
	...
	<!--   Core JS Files   -->
	<script
		src="<%=request.getContextPath()%>/resources/adminAssets/js/core/jquery.min.js"></script>
	<script
	...
	<script
		src="<%=request.getContextPath()%>/resources/adminAssets/js/plugins/perfect-scrollbar.jquery.min.js"></script>
	<!--  Google Maps Plugin    -->
	<script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
	<!-- Chart JS -->
	<script
		src="<%=request.getContextPath()%>/resources/adminAssets/js/plugins/chartjs.min.js"></script>
	<!--  Notifications Plugin    -->
	<script
		src="<%=request.getContextPath()%>/resources/adminAssets/js/plugins/bootstrap-notify.js"></script>
	<!-- Control Center for Now Ui Dashboard: parallax effects, scripts for the example pages etc -->
	<script
		src="<%=request.getContextPath()%>/resources/adminAssets/js/paper-dashboard.min.js?v=2.0.1"
		type="text/javascript"></script>
	<!-- Paper Dashboard DEMO methods, don't include it in your project! -->
	<script
		src="<%=request.getContextPath()%>/resources/adminAssets/demo/demo.js"></script>
